 ...
 *      });
 *
 * Edited by Pavel Starkov @ 4/6/2015 - plugin doesn't used in browsers supporting placeholder attribute
 *
 */
(function($){
	$.defaultText = function (opts) {
		if ('placeholder' in document.createElement('input'))
			return; // disable defaultText for modern browsers

        var selector = 'input:text[placeholder]',
            ctx = opts && opts.context ? opts.context : 'body',
            css = opts && opts.css ? opts.css : 'default',
            clearOnSubmit = opts && opts.clearOnSubmit !== undefined ? opts.clearOnSubmit : true,
            form_clear = clearOnSubmit ? [{ selector: 'form', type: 'submit' }] : [];
