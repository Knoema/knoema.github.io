	...
	var Application = (function () {
		...
		Application.prototype.addObjectsToMap = function (map, data) {
			...
			function markerClickHandler(event) {
				...
				html += "<div><label>National Development Plan Section:</label><br />" + (tooltipData["Code de l'axe stratégique de la vision 2035"] == null ? '' : tooltipData["Code de l'axe stratégique de la vision 2035"]) + '</div>';
				...
				html += '<div><label>National Development Plan:</label><br />' + (tooltipData['Numéro du projet phare / numéro de la réforme phare. (PP# / RP#)'] == null ? '' : tooltipData['Numéro du projet phare / numéro de la réforme phare. (PP# / RP#)']) + '</div>';
