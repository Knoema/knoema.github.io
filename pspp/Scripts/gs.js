$(function () {
	...
	var hoverDetails = {
		...
		"data-inventory": "Open Data Inventory Index (ODIN) assesses the coverage and openness of official statistics to identify gaps, promote open data policies, improve access, and encourage dialogue between national statistical offices (NSOs) and data users. Scores allow comparisons across topics and countries. In 2015, 125 countries were assessed.",
